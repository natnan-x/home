      ...
      >
        <article class="md:grid md:grid-cols-4 md:items-baseline">
          ...
          <template v-if="value.block">
            ...
            >
              <h2 class="text-xl flex items-start">
                {{ value.title }}
                <ArrowUpRight
                  size="16"
                  class="ml-2"
                  @click="modalOpen(value)"
                />
              </h2>
          ...
          <template v-else>
            <div
              class="pt-4 pb-10 md:col-span-3 md:p-5 rounded-2xl cursor-pointer opacity-60"
            >
  ...
  >
    <div class="modal-box">
      ...
      <div class="modal-action">
        <button class="btn btn-ghost" @click="jumpTo">
          {{ source.dialog.confirm }}
        </button>
        <button class="btn btn-neutral" @click="modalClose()">
